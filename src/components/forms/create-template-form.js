    ...
    return (
      ...
      <h2 className="modal-form__heading form__heading">Create a New Template</h2>
        <div className="modal-form__form-group form-group">
          ...
          <input type="text" name="templateLabel" className="modal-form__input form__input" />
        </div>
        <div className="modal-form__form-group form-group">
          <label for="templateContent" className="modal-form__label form__label">Text</label>
          <textarea name="templateContent" className="modal-form__input form__input modal-form__textarea form__input form__textarea" />
        </div>
        <div className="modal-form__form-group form-group">
